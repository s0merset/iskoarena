          ...
          <div className="glass-panel backdrop-blur-xl rounded-2xl p-8 border border-white/10 shadow-[0_0_50px_-12px_rgba(0,0,0,0.8)] relative overflow-hidden group">
            ...
            <form className="flex flex-col gap-5">
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  ...
                  <Link href="#" className="text-[10px] text-neon-blue hover:text-white transition-colors font-mono hover:underline decoration-neon-blue/50">FORGOT_PASSWORD?</Link>
                </div>
                <div className="relative group/input">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-slate-500">
                New administrator? 
                <Link className="text-neon-blue font-bold hover:text-white transition-colors ml-1 uppercase tracking-wide text-[10px]" href="/signup">Request Access</Link>
              </p>
            </div>
          </div>
