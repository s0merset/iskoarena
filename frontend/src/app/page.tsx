                    ...
                    <div className="bg-cyber-dark/80 rounded-[20px] p-8 relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <Link href="/signup" className="w-full">
                                <button className="w-full flex items-center justify-center gap-2 py-3 bg-slate-800/50 hover:bg-slate-700 text-slate-400 rounded-lg border border-slate-700 hover:border-slate-500 transition-colors text-xs font-bold font-mono tracking-wide group" type="button">
